...
class Scaffolding():
    ...
    # ====================================================================
    def get_initial_dplm2(args, aa_seq, struct_seq, tokenizer, pdb, ori_pdb, device):#, ori_pdb
        init_aa_seq, init_struct_seq, scaffold_length_list = create_init_seq(
            pdb, aa_seq, struct_seq, tokenizer, args
        ) # ori_pdb, 
    ...
    def create_init_seq(pdb, ori_pdb, aa_seq, struct_seq, tokenizer, args):#ori_pdb,
        num = args.num_seqs
